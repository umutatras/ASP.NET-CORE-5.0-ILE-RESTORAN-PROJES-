...
namespace RestaturanProje.Areas.Admin.Controllers
{
    ...
    public class MenuController : Controller
    {
        ...
        {
            ViewData["CategorId"] = new SelectList(_context.Categories, "Id", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["CategorId"] = new SelectList(_context.Categories, "Id", "Name", menu.CategorId);
            return View(menu);
        }
